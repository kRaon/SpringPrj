				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					<ul class="sidenav-second-level collapse" id="collapseMulti">
						...
						<li><a href="#"><i class="fa fa-fw fa-area-chart"></i>
								이달의 영수증</a></li>
						<li><a href="./getallboard.do"><i
								class="fa fa-fw fa-file"></i> 나의 영수증 관리</a></li>
				...
				<div class="col-lg-12">
					...
					<div class="card mb-3">
						<div class="card-header">
							<i class="fa fa-bar-chart"></i> 한글 테스트
						</div>
						<div class="card-body">
							<div class="row">
								...
								<div class="card mb-3">
									...
									<div class="card-body py-2 small">
										...
										<a class="mr-3 d-inline-block"
											href="./getboard.do?boardid=${boardid}"> <i
