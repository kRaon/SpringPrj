...
<body bgcolor=#FFFFFF text=#000000 leftmargin=0 topmargin=0
	...
	<br>
	<center>
		<h3><spring:message code="message.userlist.title1" ></spring:message></h3>
		<hr>
				...
				<td>
					...
					<table width=590 border=0 cellpadding=0 cellspacing=0>
						<tr>
							...
							<b><spring:message code="message.userlist.title2" ></spring:message> </b></td>
						</tr>
					</table> <br> <!-- list -->
						...
						<c:forEach var="user" items="${users}">
							<tr>
								...
								<td width=200 bgcolor="ffffff" style="padding-left: 10"><a
									href="./userview.do?id=${user.id}"> ${user.name} </a></td>
								<td width=200 align=center bgcolor="ffffff">${user.role}</td>
							</tr>
