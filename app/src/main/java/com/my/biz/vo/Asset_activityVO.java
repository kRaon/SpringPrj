...
public class Asset_activityVO {
	...
	public Asset_activityVO(int indexnumber, String id, int category_num, String contents, int amount, String fixed,
			Date a_date, String a_type) {
		super();
	...
	public String toString() {
		...
		builder.append("Asset_activityVO [indexnumber=");
